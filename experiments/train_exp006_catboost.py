"""EXP-006: 시간 순서를 유지한 CatBoost 범주형 모델."""
...
DATA_DIR = Path("./data")
ARTIFACT_DIR = Path("./artifacts/EXP-006/2024")
ID = "row_id"
...
def prepare_categorical_columns(frame: pd.DataFrame) -> pd.DataFrame:
    out = frame.copy()
...
def main() -> None:
    ...
    train = prepare_categorical_columns(train)
