...
| EXP-018 | 2026-08-10 | 계층적 기준값 + 그룹 효과 + 최근 residual 15% | 2022~2024 | 평균 0.246811188 | 평균 1140.54 | Public 895.84, EXP-013보다 하락해 비채택 |
...
LightGBM은 `iterations=200`, `num_leaves=15`, `min_child_samples=2000`, `learning_rate=0.015`를 사용한다. final residual 비중 15%는 평균 Skill 1100 이상을 유지하면서 2023 최저 성능을 20% 후보보다 높이는 제약으로 선택했다.
...
- 같은 rolling 진단의 2024 EXP-013 제출식은 Brier `0.24786249883749928`, Skill `778.3722991723918`이고 EXP-018은 Brier `0.24782026100344834`, Skill `795.2803300245504`다. 변화량은 각각 `-0.00004223783405099546`, `+16.908030852158618`이다.
