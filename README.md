...
| EXP-021 | strict rank-6 전체 학습·직렬화·제출 패키지 | **0.247633803** | **869.92** | 최종 1순위 제출 후보; Public 확인 전 리더보드 선택은 EXP-013 유지 |
| EXP-021-AGGR | R/F gate + 투수×count×타자 손 EB | **0.247622900** | **874.29** | 최신 시즌 우세지만 사후 선택 위험이 있어 2순위 진단 후보 |
...
- 1순위 `submit_exp021_strict.zip`, 2순위 `submit_exp021_aggr.zip`은 사용자가 직접 제출하고 두 Public 결과를 기록하기
- Public 결과 전까지 실제 리더보드 최고는 EXP-013 `935.8108097065`로 유지하기
- strict 후보가 EXP-013 Public을 넘는지 먼저 확인하고, aggressive 후보는 2022 하락과 사후 선택 위험을 포함한 진단 제출로만 해석하기
