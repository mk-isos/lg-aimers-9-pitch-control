"""EXP-071 exploratory frozen player-physics lookup on EXP-051."""
...
def main() -> None:
    ...
    if candidate == "strict_lowrank_s300_r6":
    ...
    elif candidate == "playerphys_resid_w025":
        exact_state = json.loads(
            (MODEL_DIR / "exact_pitchtype_control.json").read_text(
                encoding="utf-8"
            )
        ...
        post58_state = json.loads(
            (MODEL_DIR / "post58_playerphysics_lookup.json").read_text(encoding="utf-8")
        )
